...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_centromere(TOP1, TOP2, TOP3, TOP4, TOP5, TOP6, TOP7, TOP8, TOP9, TOP10, TOP11, TOP12, MID1, MID2, MID3, MID4, MID5, MID6, MID7, MID8, MID9, MID10, MID11, MID12, BOT1, BOT2, BOT3, BOT4, BOT5, BOT6, BOT7, BOT8, BOT9, BOT10, BOT11, BOT12, THU1, THU2, THU3, THU4, THU5, THU6),
};
...
const struct Chord chord_78 PROGMEM = {H_TOP3 + H_BOT3, FNC, &state_78, NULL, KC_LALT, 0, single_dance};
uint8_t state_79 = IDLE;
const struct Chord chord_79 PROGMEM = {H_TOP4 + H_BOT4, FNC, &state_79, NULL, KC_LCTL, 0, single_dance};
uint8_t state_80 = IDLE;
const struct Chord chord_80 PROGMEM = {H_TOP5 + H_BOT5, FNC, &state_80, NULL, KC_LSFT, 0, single_dance};
uint8_t state_81 = IDLE;
const struct Chord chord_81 PROGMEM = {H_TOP6 + H_BOT6, FNC, &state_81, NULL, KC_LGUI, 0, single_dance};
uint8_t state_82 = IDLE;
const struct Chord chord_82 PROGMEM = {H_TOP7 + H_BOT7, FNC, &state_82, NULL, KC_RGUI, 0, single_dance};
uint8_t state_83 = IDLE;
const struct Chord chord_83 PROGMEM = {H_TOP8 + H_BOT8, FNC, &state_83, NULL, KC_RSFT, 0, single_dance};
uint8_t state_84 = IDLE;
const struct Chord chord_84 PROGMEM = {H_TOP9 + H_BOT9, FNC, &state_84, NULL, KC_RCTL, 0, single_dance};
uint8_t state_85 = IDLE;
const struct Chord chord_85 PROGMEM = {H_TOP10 + H_BOT10, FNC, &state_85, NULL, KC_RALT, 0, single_dance};
...
const struct Chord chord_91 PROGMEM = {H_TOP3 + H_BOT3, NAV, &state_91, NULL, KC_LALT, 0, single_dance};
uint8_t state_92 = IDLE;
const struct Chord chord_92 PROGMEM = {H_TOP4 + H_BOT4, NAV, &state_92, NULL, KC_LCTL, 0, single_dance};
uint8_t state_93 = IDLE;
const struct Chord chord_93 PROGMEM = {H_TOP5 + H_BOT5, NAV, &state_93, NULL, KC_LSFT, 0, single_dance};
uint8_t state_94 = IDLE;
const struct Chord chord_94 PROGMEM = {H_TOP6 + H_BOT6, NAV, &state_94, NULL, KC_LGUI, 0, single_dance};
...
const struct Chord chord_103 PROGMEM = {H_TOP3 + H_BOT3, MOUSE, &state_103, NULL, KC_LALT, 0, single_dance};
uint8_t state_104 = IDLE;
const struct Chord chord_104 PROGMEM = {H_TOP4 + H_BOT4, MOUSE, &state_104, NULL, KC_LCTL, 0, single_dance};
uint8_t state_105 = IDLE;
const struct Chord chord_105 PROGMEM = {H_TOP5 + H_BOT5, MOUSE, &state_105, NULL, KC_LSFT, 0, single_dance};
uint8_t state_106 = IDLE;
const struct Chord chord_106 PROGMEM = {H_TOP6 + H_BOT6, MOUSE, &state_106, NULL, KC_LGUI, 0, single_dance};
