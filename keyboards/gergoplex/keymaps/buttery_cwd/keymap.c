...
#define H_THU3 ((HASH_TYPE) 1 << 32)
#define H_THU4 ((HASH_TYPE) 1 << 33)
#define H_THU5 ((HASH_TYPE) 1 << 34)
#define H_THU6 ((HASH_TYPE) 1 << 35)

enum internal_keycodes {
    TOP1 = SAFE_RANGE,
    TOP2, TOP3, TOP4, TOP5, TOP6, TOP7, TOP8, TOP9, TOP10, MID1, MID2, MID3, MID4, MID5, MID6, MID7, MID8, MID9, MID10, BOT1, BOT2, BOT3, BOT4, BOT5, BOT6, BOT7, BOT8, BOT9, BOT10, THU1, THU2, THU3, THU4, THU5, THU6,
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_gergoplex(TOP1, TOP2, TOP3, TOP4, TOP5, TOP6, TOP7, TOP8, TOP9, TOP10, MID1, MID2, MID3, MID4, MID5, MID6, MID7, MID8, MID9, MID10, BOT1, BOT2, BOT3, BOT4, BOT5, BOT6, BOT7, BOT8, BOT9, BOT10, THU1, THU2, THU3, THU4, THU5, THU6),
};
...
const struct Chord chord_0 PROGMEM = {H_TOP1 + H_TOP10 + H_MID1 + H_MID10, ALWAYS_ON, &state_0, NULL, 0, 0, clear};
uint8_t state_1 = IDLE;
const struct Chord chord_1 PROGMEM = {H_TOP5 + H_TOP6 + H_MID5 + H_MID6, ALWAYS_ON, &state_1, NULL, 0, 0, command};
uint8_t state_2 = IDLE;
const struct Chord chord_2 PROGMEM = {H_TOP1, QWERTY, &state_2, NULL, KC_Q, 0, single_dance};
uint8_t state_3 = IDLE;
const struct Chord chord_3 PROGMEM = {H_TOP2, QWERTY, &state_3, NULL, KC_W, 0, single_dance};
uint8_t state_4 = IDLE;
const struct Chord chord_4 PROGMEM = {H_TOP3, QWERTY, &state_4, NULL, KC_E, 0, single_dance};
uint8_t state_5 = IDLE;
const struct Chord chord_5 PROGMEM = {H_TOP4, QWERTY, &state_5, NULL, KC_R, 0, single_dance};
uint8_t state_6 = IDLE;
const struct Chord chord_6 PROGMEM = {H_TOP5, QWERTY, &state_6, NULL, KC_T, 0, single_dance};
uint8_t state_7 = IDLE;
const struct Chord chord_7 PROGMEM = {H_TOP6, QWERTY, &state_7, NULL, KC_Y, 0, single_dance};
uint8_t state_8 = IDLE;
const struct Chord chord_8 PROGMEM = {H_TOP7, QWERTY, &state_8, NULL, KC_U, 0, single_dance};
uint8_t state_9 = IDLE;
const struct Chord chord_9 PROGMEM = {H_TOP8, QWERTY, &state_9, NULL, KC_I, 0, single_dance};
uint8_t state_10 = IDLE;
const struct Chord chord_10 PROGMEM = {H_TOP9, QWERTY, &state_10, NULL, KC_O, 0, single_dance};
uint8_t state_11 = IDLE;
const struct Chord chord_11 PROGMEM = {H_TOP10, QWERTY, &state_11, NULL, KC_P, 0, single_dance};
uint8_t state_12 = IDLE;
const struct Chord chord_12 PROGMEM = {H_TOP1 + H_BOT1, QWERTY, &state_12, NULL, KC_A, 0, single_dance};
uint8_t state_13 = IDLE;
uint8_t counter_13 = 0;
const struct Chord chord_13 PROGMEM = {H_TOP2 + H_BOT2, QWERTY, &state_13, &counter_13, KC_S, KC_LALT, key_key_dance};
uint8_t state_14 = IDLE;
const struct Chord chord_14 PROGMEM = {H_TOP3 + H_BOT3, QWERTY, &state_14, NULL, KC_D, KC_LCTL, key_mod_dance};
uint8_t state_15 = IDLE;
const struct Chord chord_15 PROGMEM = {H_TOP4 + H_BOT4, QWERTY, &state_15, NULL, KC_F, KC_LSFT, key_mod_dance};
uint8_t state_16 = IDLE;
uint8_t counter_16 = 0;
const struct Chord chord_16 PROGMEM = {H_TOP5 + H_BOT5, QWERTY, &state_16, &counter_16, KC_G, KC_LGUI, key_key_dance};
uint8_t state_17 = IDLE;
uint8_t counter_17 = 0;
const struct Chord chord_17 PROGMEM = {H_TOP6 + H_BOT6, QWERTY, &state_17, &counter_17, KC_H, KC_RGUI, key_key_dance};
uint8_t state_18 = IDLE;
const struct Chord chord_18 PROGMEM = {H_TOP7 + H_BOT7, QWERTY, &state_18, NULL, KC_J, KC_RSFT, key_mod_dance};
uint8_t state_19 = IDLE;
const struct Chord chord_19 PROGMEM = {H_TOP8 + H_BOT8, QWERTY, &state_19, NULL, KC_K, KC_RCTL, key_mod_dance};
uint8_t state_20 = IDLE;
uint8_t counter_20 = 0;
const struct Chord chord_20 PROGMEM = {H_TOP9 + H_BOT9, QWERTY, &state_20, &counter_20, KC_L, KC_RALT, key_key_dance};
uint8_t state_21 = IDLE;
const struct Chord chord_21 PROGMEM = {H_TOP10 + H_BOT10, QWERTY, &state_21, NULL, KC_SCOLON, 0, single_dance};
uint8_t state_22 = IDLE;
const struct Chord chord_22 PROGMEM = {H_BOT1, QWERTY, &state_22, NULL, KC_Z, 0, single_dance};
uint8_t state_23 = IDLE;
const struct Chord chord_23 PROGMEM = {H_BOT2, QWERTY, &state_23, NULL, KC_X, 0, single_dance};
uint8_t state_24 = IDLE;
const struct Chord chord_24 PROGMEM = {H_BOT3, QWERTY, &state_24, NULL, KC_C, 0, single_dance};
uint8_t state_25 = IDLE;
const struct Chord chord_25 PROGMEM = {H_BOT4, QWERTY, &state_25, NULL, KC_V, 0, single_dance};
uint8_t state_26 = IDLE;
const struct Chord chord_26 PROGMEM = {H_BOT5, QWERTY, &state_26, NULL, KC_B, 0, single_dance};
uint8_t state_27 = IDLE;
const struct Chord chord_27 PROGMEM = {H_BOT6, QWERTY, &state_27, NULL, KC_N, 0, single_dance};
uint8_t state_28 = IDLE;
const struct Chord chord_28 PROGMEM = {H_BOT7, QWERTY, &state_28, NULL, KC_M, 0, single_dance};
uint8_t state_29 = IDLE;
const struct Chord chord_29 PROGMEM = {H_BOT8, QWERTY, &state_29, NULL, KC_COMMA, 0, single_dance};
uint8_t state_30 = IDLE;
const struct Chord chord_30 PROGMEM = {H_BOT9, QWERTY, &state_30, NULL, KC_DOT, 0, single_dance};
uint8_t state_31 = IDLE;
const struct Chord chord_31 PROGMEM = {H_BOT10, QWERTY, &state_31, NULL, KC_SLASH, 0, single_dance};
uint8_t state_32 = IDLE;
const struct Chord chord_32 PROGMEM = {H_THU1, QWERTY, &state_32, NULL, KC_ENTER, 0, single_dance};
uint8_t state_33 = IDLE;
uint8_t counter_33 = 0;
const struct Chord chord_33 PROGMEM = {H_THU2, QWERTY, &state_33, &counter_33, KC_SPC, NUM, key_layer_dance};
uint8_t state_34 = IDLE;
uint8_t counter_34 = 0;
const struct Chord chord_34 PROGMEM = {H_THU3, QWERTY, &state_34, &counter_34, KC_BSPC, NAV, key_layer_dance};
uint8_t state_35 = IDLE;
const struct Chord chord_35 PROGMEM = {H_THU4, QWERTY, &state_35, NULL, KC_DEL, 0, single_dance};
uint8_t state_36 = IDLE;
uint8_t counter_36 = 0;
const struct Chord chord_36 PROGMEM = {H_THU5, QWERTY, &state_36, &counter_36, KC_SPC, FNC, key_layer_dance};
uint8_t state_37 = IDLE;
const struct Chord chord_37 PROGMEM = {H_THU6, QWERTY, &state_37, NULL, KC_ENTER, 0, single_dance};
uint8_t state_38 = IDLE;
const struct Chord chord_38 PROGMEM = {H_THU2 + H_THU3, QWERTY, &state_38, NULL, MOUSE, 0, temp_pseudolayer};
...
const struct Chord chord_48 PROGMEM = {H_TOP10, NUM, &state_48, NULL, KC_0, 0, single_dance};
uint8_t state_49 = IDLE;
const struct Chord chord_49 PROGMEM = {H_TOP2 + H_BOT2, NUM, &state_49, NULL, KC_LALT, 0, single_dance};
uint8_t state_50 = IDLE;
const struct Chord chord_50 PROGMEM = {H_TOP3 + H_BOT3, NUM, &state_50, NULL, KC_LCTL, 0, single_dance};
uint8_t state_51 = IDLE;
const struct Chord chord_51 PROGMEM = {H_TOP4 + H_BOT4, NUM, &state_51, NULL, KC_LSFT, 0, single_dance};
uint8_t state_52 = IDLE;
const struct Chord chord_52 PROGMEM = {H_TOP5 + H_BOT5, NUM, &state_52, NULL, KC_LGUI, 0, single_dance};
uint8_t state_53 = IDLE;
const struct Chord chord_53 PROGMEM = {H_TOP6 + H_BOT6, NUM, &state_53, NULL, KC_RGUI, 0, single_dance};
uint8_t state_54 = IDLE;
const struct Chord chord_54 PROGMEM = {H_TOP7 + H_BOT7, NUM, &state_54, NULL, KC_RSFT, 0, single_dance};
uint8_t state_55 = IDLE;
const struct Chord chord_55 PROGMEM = {H_TOP8 + H_BOT8, NUM, &state_55, NULL, KC_RCTL, 0, single_dance};
uint8_t state_56 = IDLE;
const struct Chord chord_56 PROGMEM = {H_TOP9 + H_BOT9, NUM, &state_56, NULL, KC_RALT, 0, single_dance};
uint8_t state_57 = IDLE;
const struct Chord chord_57 PROGMEM = {H_BOT9, NUM, &state_57, NULL, KC_LBRACKET, 0, single_dance};
uint8_t state_58 = IDLE;
const struct Chord chord_58 PROGMEM = {H_BOT10, NUM, &state_58, NULL, KC_RBRACKET, 0, single_dance};
uint8_t state_59 = IDLE;
const struct Chord chord_59 PROGMEM = {H_TOP1, FNC, &state_59, NULL, KC_F1, 0, single_dance};
uint8_t state_60 = IDLE;
const struct Chord chord_60 PROGMEM = {H_TOP2, FNC, &state_60, NULL, KC_F2, 0, single_dance};
uint8_t state_61 = IDLE;
const struct Chord chord_61 PROGMEM = {H_TOP3, FNC, &state_61, NULL, KC_F3, 0, single_dance};
uint8_t state_62 = IDLE;
const struct Chord chord_62 PROGMEM = {H_TOP4, FNC, &state_62, NULL, KC_F4, 0, single_dance};
uint8_t state_63 = IDLE;
const struct Chord chord_63 PROGMEM = {H_TOP5, FNC, &state_63, NULL, KC_F5, 0, single_dance};
uint8_t state_64 = IDLE;
const struct Chord chord_64 PROGMEM = {H_TOP6, FNC, &state_64, NULL, KC_F6, 0, single_dance};
uint8_t state_65 = IDLE;
const struct Chord chord_65 PROGMEM = {H_TOP7, FNC, &state_65, NULL, KC_F7, 0, single_dance};
uint8_t state_66 = IDLE;
const struct Chord chord_66 PROGMEM = {H_TOP8, FNC, &state_66, NULL, KC_F8, 0, single_dance};
uint8_t state_67 = IDLE;
const struct Chord chord_67 PROGMEM = {H_TOP9, FNC, &state_67, NULL, KC_F9, 0, single_dance};
uint8_t state_68 = IDLE;
const struct Chord chord_68 PROGMEM = {H_TOP10, FNC, &state_68, NULL, KC_F10, 0, single_dance};
uint8_t state_69 = IDLE;
const struct Chord chord_69 PROGMEM = {H_TOP2 + H_BOT2, FNC, &state_69, NULL, KC_LALT, 0, single_dance};
uint8_t state_70 = IDLE;
const struct Chord chord_70 PROGMEM = {H_TOP3 + H_BOT3, FNC, &state_70, NULL, KC_LCTL, 0, single_dance};
uint8_t state_71 = IDLE;
const struct Chord chord_71 PROGMEM = {H_TOP4 + H_BOT4, FNC, &state_71, NULL, KC_LSFT, 0, single_dance};
uint8_t state_72 = IDLE;
const struct Chord chord_72 PROGMEM = {H_TOP5 + H_BOT5, FNC, &state_72, NULL, KC_LGUI, 0, single_dance};
uint8_t state_73 = IDLE;
const struct Chord chord_73 PROGMEM = {H_TOP6 + H_BOT6, FNC, &state_73, NULL, KC_RGUI, 0, single_dance};
uint8_t state_74 = IDLE;
const struct Chord chord_74 PROGMEM = {H_TOP7 + H_BOT7, FNC, &state_74, NULL, KC_RSFT, 0, single_dance};
uint8_t state_75 = IDLE;
const struct Chord chord_75 PROGMEM = {H_TOP8 + H_BOT8, FNC, &state_75, NULL, KC_RCTL, 0, single_dance};
uint8_t state_76 = IDLE;
const struct Chord chord_76 PROGMEM = {H_TOP9 + H_BOT9, FNC, &state_76, NULL, KC_RALT, 0, single_dance};
uint8_t state_77 = IDLE;
const struct Chord chord_77 PROGMEM = {H_TOP7, NAV, &state_77, NULL, KC_HOME, 0, single_dance};
uint8_t state_78 = IDLE;
const struct Chord chord_78 PROGMEM = {H_TOP8, NAV, &state_78, NULL, KC_UP, 0, single_dance};
uint8_t state_79 = IDLE;
const struct Chord chord_79 PROGMEM = {H_TOP9, NAV, &state_79, NULL, KC_END, 0, single_dance};
uint8_t state_80 = IDLE;
const struct Chord chord_80 PROGMEM = {H_TOP10, NAV, &state_80, NULL, KC_PGUP, 0, single_dance};
uint8_t state_81 = IDLE;
const struct Chord chord_81 PROGMEM = {H_TOP2 + H_BOT2, NAV, &state_81, NULL, KC_LALT, 0, single_dance};
uint8_t state_82 = IDLE;
const struct Chord chord_82 PROGMEM = {H_TOP3 + H_BOT3, NAV, &state_82, NULL, KC_LCTL, 0, single_dance};
uint8_t state_83 = IDLE;
const struct Chord chord_83 PROGMEM = {H_TOP4 + H_BOT4, NAV, &state_83, NULL, KC_LSFT, 0, single_dance};
uint8_t state_84 = IDLE;
const struct Chord chord_84 PROGMEM = {H_TOP5 + H_BOT5, NAV, &state_84, NULL, KC_LGUI, 0, single_dance};
uint8_t state_85 = IDLE;
const struct Chord chord_85 PROGMEM = {H_BOT7, NAV, &state_85, NULL, KC_LEFT, 0, single_dance};
uint8_t state_86 = IDLE;
const struct Chord chord_86 PROGMEM = {H_BOT8, NAV, &state_86, NULL, KC_DOWN, 0, single_dance};
uint8_t state_87 = IDLE;
const struct Chord chord_87 PROGMEM = {H_BOT9, NAV, &state_87, NULL, KC_RIGHT, 0, single_dance};
uint8_t state_88 = IDLE;
const struct Chord chord_88 PROGMEM = {H_BOT10, NAV, &state_88, NULL, KC_PGDN, 0, single_dance};
uint8_t state_89 = IDLE;
const struct Chord chord_89 PROGMEM = {H_TOP7, MOUSE, &state_89, NULL, KC_BTN1, 0, single_dance};
uint8_t state_90 = IDLE;
const struct Chord chord_90 PROGMEM = {H_TOP8, MOUSE, &state_90, NULL, KC_MS_U, 0, single_dance};
uint8_t state_91 = IDLE;
const struct Chord chord_91 PROGMEM = {H_TOP9, MOUSE, &state_91, NULL, KC_BTN2, 0, single_dance};
uint8_t state_92 = IDLE;
const struct Chord chord_92 PROGMEM = {H_TOP10, MOUSE, &state_92, NULL, KC_WH_U, 0, single_dance};
uint8_t state_93 = IDLE;
const struct Chord chord_93 PROGMEM = {H_TOP2 + H_BOT2, MOUSE, &state_93, NULL, KC_LALT, 0, single_dance};
uint8_t state_94 = IDLE;
const struct Chord chord_94 PROGMEM = {H_TOP3 + H_BOT3, MOUSE, &state_94, NULL, KC_LCTL, 0, single_dance};
uint8_t state_95 = IDLE;
const struct Chord chord_95 PROGMEM = {H_TOP4 + H_BOT4, MOUSE, &state_95, NULL, KC_LSFT, 0, single_dance};
uint8_t state_96 = IDLE;
const struct Chord chord_96 PROGMEM = {H_TOP5 + H_BOT5, MOUSE, &state_96, NULL, KC_LGUI, 0, single_dance};
uint8_t state_97 = IDLE;
const struct Chord chord_97 PROGMEM = {H_BOT7, MOUSE, &state_97, NULL, KC_MS_L, 0, single_dance};
uint8_t state_98 = IDLE;
const struct Chord chord_98 PROGMEM = {H_BOT8, MOUSE, &state_98, NULL, KC_MS_D, 0, single_dance};
uint8_t state_99 = IDLE;
const struct Chord chord_99 PROGMEM = {H_BOT9, MOUSE, &state_99, NULL, KC_MS_R, 0, single_dance};
uint8_t state_100 = IDLE;
const struct Chord chord_100 PROGMEM = {H_BOT10, MOUSE, &state_100, NULL, KC_WH_D, 0, single_dance};

const struct Chord* const list_of_chords[] PROGMEM = {
    &chord_0, &chord_1, &chord_2, &chord_3, &chord_4, &chord_5, &chord_6, &chord_7, &chord_8, &chord_9, &chord_10, &chord_11, &chord_12, &chord_13, &chord_14, &chord_15, &chord_16, &chord_17, &chord_18, &chord_19, &chord_20, &chord_21, &chord_22, &chord_23, &chord_24, &chord_25, &chord_26, &chord_27, &chord_28, &chord_29, &chord_30, &chord_31, &chord_32, &chord_33, &chord_34, &chord_35, &chord_36, &chord_37, &chord_38, &chord_39, &chord_40, &chord_41, &chord_42, &chord_43, &chord_44, &chord_45, &chord_46, &chord_47, &chord_48, &chord_49, &chord_50, &chord_51, &chord_52, &chord_53, &chord_54, &chord_55, &chord_56, &chord_57, &chord_58, &chord_59, &chord_60, &chord_61, &chord_62, &chord_63, &chord_64, &chord_65, &chord_66, &chord_67, &chord_68, &chord_69, &chord_70, &chord_71, &chord_72, &chord_73, &chord_74, &chord_75, &chord_76, &chord_77, &chord_78, &chord_79, &chord_80, &chord_81, &chord_82, &chord_83, &chord_84, &chord_85, &chord_86, &chord_87, &chord_88, &chord_89, &chord_90, &chord_91, &chord_92, &chord_93, &chord_94, &chord_95, &chord_96, &chord_97, &chord_98, &chord_99, &chord_100
};

const uint16_t** const leader_triggers PROGMEM = NULL;
void (*leader_functions[]) (void) = {};

#define NUMBER_OF_CHORDS 101
